        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationText = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactAdress = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    Phone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    About = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    DreamTitle = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "RestaurantToFetaures",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RestaurantId = table.Column<int>(type: "int", nullable: false),
                    FetaureId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantToFetaures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantToFetaures_Features_FetaureId",
                        column: x => x.FetaureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantToFetaures_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantToFetaures_FetaureId",
                table: "RestaurantToFetaures",
                column: "FetaureId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantToFetaures_RestaurantId",
                table: "RestaurantToFetaures",
                column: "RestaurantId");
